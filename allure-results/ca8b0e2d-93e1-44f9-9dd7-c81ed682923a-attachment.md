...
- Name: test alerts and dialogs
- Location: D:\All Work\playwright-ts-demo\tests\example.spec.ts:142:5
...
Call log:
  - setting frame content, waiting until "load"
    ...
    at D:\All Work\playwright-ts-demo\tests\example.spec.ts:144:14
```
